...
<div class="chart">
    <div class="chart_header">
        ...
        <div class="chart_title">
            <p class="title">Cumulative VDF iterations</p>
            <p class="subtitle" >Verifiable delay function proofs (VDFs), also known as "Proofs of time" are cryptographic proofs that a sequential computation was performed on a given input for a given number of iterations. These create time between blocks so that generating an alternative blockchain would take a very long time.</p>
        </div>
    </div>
